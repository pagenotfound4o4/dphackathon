...
public class GetSortedTimeFavouriteAsyncTask extends AsyncTask<String, Void, List<Business>> {
    private MainHomeFragment fragment;
    private String uid;
    private String state;

    public GetSortedTimeFavouriteAsyncTask(MainHomeFragment fragment, String uid, String state) {
    ...
    protected List<Business> doInBackground(String... params) {
        return SyncHelper.getInstance().getBusinessListBySortedTime(uid, state, params[0]);
    }
